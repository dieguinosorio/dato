...
var url = 'http://localhost/blog/public/';
var IdSocial = document.getElementById("socialnum").value;
...
//                } else {
//                    console.log("ocurrio un error like");
//                }
//            }
//        });
    })
...
function download(dataURL, filename) {
    ...
    filename = document.getElementById("socialnum").value;
    if (filename > 0) {
        $.ajax({
            url: url + 'signature',
            data: {img_data: dataURL, social: filename},
            type: 'POST',
            dataType: 'json',
            success: function (response) {

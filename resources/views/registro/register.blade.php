                ...
                <form method="POST" action="{{action('EmpresasController@register',['Id'=>$empresa->name])}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="sel1" name="opciud" required>
                                <option>(sel)</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="fhbirth" type="date" class="form-control" name="fhbirth" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="dir" type="text" class="form-control" name="dir" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="dir2" type="text" class="form-control" name="dir2" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="zipcode" type="email" class="form-control" name="email" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="socialnum" type="number" class="form-control" name="socialnum" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="numdep" type="number" class="form-control" name="numdep" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="contactemer" type="text" class="form-control" name="contactemer" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="surnamecon" type="text" class="form-control" name="surnamecon" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="telcon" type="tel" class="form-control" name="telcon" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="namesur" type="text" class="form-control" name="namesur" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Acoustical Ceiling Mechanic" name="jobs1" >Acoustical Ceiling Mechanic
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Layout / Blueprints" name="jobs1">Layout / Blueprints
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Drywall Metal Framing Mechanic" name="jobs1" >Drywall Metal Framing Mechanic
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Drywall Hanger" name="jobs1" >Drywall Hanger
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Drywall Finisher" name="jobs1" >Drywall Finisher
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="General Laborer" name="job2">General Laborer
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Plaster Tradesman" name="job2">Plaster Tradesman
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Concrete Forming" name="job2" >Concrete Forming
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Concrete Finisher" name="job2" >Concrete Finisher
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" value="Safety Jobsite" name="job2" >Safety Jobsite
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="mil">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="mil">No
                                </label>
                            </div>
                            @if ($errors->has('mil'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="dem">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="dem">No
                                </label>
                            </div>
                            @if ($errors->has('dem'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="demc">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="demc">No
                                </label>
                            </div>
                            @if ($errors->has('demc'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="dispmov">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="dispmov">No
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="clause">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="clause">No
                                </label>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="term">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="term">No
                                </label>
                            </div>
                            @if ($errors->has('term'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="namesur" type="date" class="form-control" value="{{date('Y-m-d')}}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="1" name="acept">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="0" name="acept">No
                                </label>
                            </div>
